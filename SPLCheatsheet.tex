...
{\textsc{\{ Shakespeare Programming Lannguage \ \ \ \ \ C h e a t \ \ \ \ \ S h e e t\} \hspace{12pt}}}
...
% Layout of a play
%------------------------------------------------
\headerbox{Layout of a play:}{name=objectives,column=0,row=0}{
...
\headerbox{Lines in Dialogs}{name=introduction,column=1,row=0,bottomaligned=objectives}{
